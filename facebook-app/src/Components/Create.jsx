    ...
    return (
        <div id="create-con">
            <div className="create-left">
                <div className='close-home'>
                    <img onClick={()=>router("/")} src="https://www.freeiconspng.com/thumbs/close-button-png/silver-close-button-png-15.png" />
                    <img onClick={()=>router("/")} src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/05/Facebook_Logo_%282019%29.png/1024px-Facebook_Logo_%282019%29.png" />
                </div>

                <div className='flex-x'>
                    <h3>Your story</h3>
                    <i className="fa-solid fa-gear fa-xl" style={{ color: '#1a1a1a' }}></i>
                </div>

                <div className='prof'>
                    <img src="https://scontent.fbom5-1.fna.fbcdn.net/v/t39.30808-6/316407627_2285357611642990_1364941092960111903_n.jpg?_nc_cat=104&ccb=1-7&_nc_sid=09cbfe&_nc_ohc=5PoRr_1PAPkAX85x_z3&_nc_ht=scontent.fbom5-1.fna&oh=00_AfBSC-Jbya3qya96APu6-xlDl6zX_r2yKtTJb7dZ6HTL1w&oe=64E2BBC4" />
                    <h5>Chetan Patil</h5>
                </div>
            ...
            <div className="create-right">
                <div>
                  ...
                  <div className="create-text-photo">

                    <div className="create-photo">
                        <img src="https://www.shareicon.net/data/512x512/2017/03/02/880210_images_512x512.png" />
                        <h6>Create a Photo Story</h6>
                    </div>

                    <div className="create-text">
                        <img src="https://icons.veryicon.com/png/o/miscellaneous/smarteditor/aa-3.png" />
