    ...
    return (
        <div className='fb-home'>
            <div className="fb-1">
                ...
                <div className="cat-list">
                    <img src="https://cdn0.iconfinder.com/data/icons/facebook-feature-outline/32/facebook-18-512.png" />
                    <h6>Memories</h6>
                </div>
                <div className="cat-list">
                    <img src="https://icons-for-free.com/iconfiles/png/512/save+tag+tagged+photo+icon-1320184025431372796.png" />
                    <h6>Saved</h6>
                </div>
                <div className="cat-list">
                    <img src="https://e7.pngegg.com/pngimages/603/650/png-clipart-computer-icons-facebook-private-miscellaneous-blue.png" />
                    <h6>Groups</h6>
                </div>
                <div className="cat-list">
                    <img src="https://mpng.hippopng.com/20180928/pjy/kisspng-youtube-video-logo-image-computer-icons-ulfix-s-c-5baecc2067cfa0.8310528015381821764252.jpg" />
                    <h6>Video</h6>
                </div>
                <div className="cat-list">
                    <img src="https://okcredit-blog-images-prod.storage.googleapis.com/2021/05/facebookmarketplace2.jpg" />
                    <h6>Marketplace</h6>
                </div>
                <div className="cat-list">
                    <img src="https://static.xx.fbcdn.net/rsrc.php/v3/yb/r/eECk3ceTaHJ.png" />
                    <h6>Feeds</h6>
                </div>
                <div className="cat-list">
                    <img src="https://static.xx.fbcdn.net/rsrc.php/v3/yx/r/WMOYDeEqIYv.png" />
                    <h6>Events</h6>
                </div>
                <div className="cat-list">
                    <img src="https://static.xx.fbcdn.net/rsrc.php/v3/yN/r/ATlxuj_J5ty.png" />
                    <h6>Ads Manager</h6>
                </div>
                <div className="cat-list">
                    <img src="https://static.thenounproject.com/png/716717-200.png" />
                    <h6>See more</h6>
                </div>
                <hr />
            ...
            <div className="fb-2">
                ...
                <div className="post">
                    <div className='tag'>
                        <img src="https://scontent.fbom5-1.fna.fbcdn.net/v/t39.30808-1/353841857_3337127816547939_4406969581640332675_n.jpg?stp=cp0_dst-jpg_p24x24&_nc_cat=1&ccb=1-7&_nc_sid=0222cc&_nc_ohc=xLAj1peU14EAX-52loo&_nc_ht=scontent.fbom5-1.fna&oh=00_AfCxvuu9GgoDdaEkEWTDSNvpTlZ_V_AbQFtpc93-8mLZiw&oe=64DFB6BA" />
                        <div className='heading'>
                            <h6>Spongebob Squarepants Memes </h6>
                            <span>Ëdwârd  · 6 d·
                                <span>
                                    <i className="fa-solid fa-earth-asia" style={{ color: '#262626' }}></i>
                                </span>
                            </span>
                        </div>
                        <div className='cros'>
                    ...
                    <img className='post-banner'
                        src="https://scontent.fbom5-1.fna.fbcdn.net/v/t39.30808-6/365734283_3372399656354088_6850914218768674918_n.jpg?stp=cp6_dst-jpg_p526x296&_nc_cat=1&ccb=1-7&_nc_sid=0f5592&_nc_ohc=qjP5Z11Sv1cAX9rYj_n&_nc_ht=scontent.fbom5-1.fna&oh=00_AfAvoduFKesBinDcdjBY-vqtXVdKnfRqqwohUfnZaYLdGQ&oe=64DE7F18" />

                    <div className="likes">
                        <div className='flex'>
                            <img src="https://image.similarpng.com/very-thumbnail/2020/11/Blue-like-icon-on-transparent-background-PNG.png" />
                            <p>150K</p>
                        </div>
                        <p>200 Comments 10 Shares</p>
                    </div>
                    <hr />
                ...
                <div className="post">
                    <div className='tag'>
                        <img src="https://scontent.fbom5-1.fna.fbcdn.net/v/t39.30808-1/336652099_609794090538809_4085675960927788517_n.jpg?stp=cp0_dst-jpg_p40x40&_nc_cat=1&ccb=1-7&_nc_sid=c7e18e&_nc_ohc=-NrXjI3z5hoAX-h9MHQ&_nc_ht=scontent.fbom5-1.fna&oh=00_AfAQUKvPFWYvDcJEBjowPHK9kI0rgZ_M6YyLI2cV-bH1zg&oe=64DEB401" />
                        <div className='heading'>
                            <h6>Cozy Rustic Homes</h6>
                            <span>3 d·
                                <span>
                                    <i className="fa-solid fa-earth-asia" style={{ color: '#262626' }}></i>
                                </span>
                    ...
                    <img className='post-banner'
                        src="https://scontent.fbom5-1.fna.fbcdn.net/v/t39.30808-6/364801284_215681501465189_268673858223353869_n.jpg?stp=dst-jpg_p526x296&_nc_cat=1&ccb=1-7&_nc_sid=7f8c78&_nc_ohc=oQJH-Bf-nx8AX-pLY1j&_nc_ht=scontent.fbom5-1.fna&oh=00_AfDuoOkmasWGWDMS6wIG8w1m3KzYF1mylsib4oAs277tNQ&oe=64DF1B3E" />
